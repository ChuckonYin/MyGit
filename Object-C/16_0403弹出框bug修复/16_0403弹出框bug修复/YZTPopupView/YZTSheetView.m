...
//        }
        ...
        for ( NSInteger i = 0 ; i < items.count; ++i )
        {
            ...
            [btn mas_makeConstraints:^(MASConstraintMaker *make) {
                ...
                make.left.right.equalTo(self.buttonView).insets(UIEdgeInsetsMake(0, 0, 0, -MM_SPLIT_WIDTH));
//                make.left.right.equalTo(self.buttonView).insets(UIEdgeInsetsMake(0, 14, 0, -MM_SPLIT_WIDTH));
        ...
        [self.cancelButton mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            make.height.mas_equalTo(config.buttonCancelHeight);
            make.centerY.mas_equalTo(self.titleView.mas_centerY);
            make.width.mas_equalTo(44);
            
        }];
        self.cancelButton.titleLabel.font = [UIFont systemFontOfSize:config.buttonCancelFontSize];
//        [self.cancelButton setBackgroundImage:[UIImage mm_imageWithColor:config.backgroundColor] forState:UIControlStateNormal];
        [self.cancelButton setTitleColor:[UIColor colorWithRed:74/255.0 green:144/255.0 blue:226/255.0 alpha:1] forState:UIControlStateHighlighted];
...
- (instancetype)init
{
    ...
    if ( self )
    {
        ...
        self.buttonCancelHeight = 44.0f;
        self.innerMargin    = 19.0f;
        
        self.titleFontSize          = 16.0f;
        self.buttonCancelFontSize   = 14.0f;
        ...
        self.itemCancelColor    = RGB(155, 155, 155);
        self.itemNormalColor    = RGB(74, 74, 74);
        self.itemDisableColor   = RGB(204, 204, 204);
        self.itemHighlightColor = kGlobalColor;
        self.itemPressedColor   = RGB(239, 237, 231);
