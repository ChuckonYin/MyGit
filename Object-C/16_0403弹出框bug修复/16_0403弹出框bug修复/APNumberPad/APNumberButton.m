...
+ (instancetype)buttonWithBackgroundImage:(UIImage *)backgroundImage highlightedImage:(UIImage *)highlightedImage {
    return [[self alloc] initWithBackgroundImage:backgroundImage highlightedImage:highlightedImage];
}

- (instancetype)initWithBackgroundImage:(UIImage *)backgroundImage highlightedImage:(UIImage *)highlightedImage {
    self = [super initWithFrame:CGRectZero];
    if (self) {
