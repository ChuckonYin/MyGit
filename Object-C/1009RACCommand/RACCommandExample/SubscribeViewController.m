...
//    [NSTimer scheduledTimerWithTimeInterval:3 target:self selector:@selector(timerAct) userInfo:nil repeats:YES];
}

-(void)timerAct
{
    NSLog(@"email====%@",self.viewModel.email);
    NSLog(@"btn_comand====%@",self.subscribeButton.rac_command);
}
#pragma mark - Views
