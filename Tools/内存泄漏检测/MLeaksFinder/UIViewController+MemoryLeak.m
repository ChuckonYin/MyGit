...
//Add by lynn
const void *const kHasBeenDismissedKey = &kHasBeenDismissedKey;
...
- (void)swizzled_viewDidDisappear:(BOOL)animated {
    ...
    //add by lynn
    if ([objc_getAssociatedObject(self, kHasBeenDismissedKey) boolValue]) {
        [self willDealloc];
        return;
    }
}
...
- (void)swizzled_viewWillAppear:(BOOL)animated {
    ...
    //add by lynn
    objc_setAssociatedObject(self, kHasBeenDismissedKey, @(NO), OBJC_ASSOCIATION_RETAIN);
}
...
//    [dismissedViewController willDealloc];
    ...
    //add by lynn
    objc_setAssociatedObject(self, kHasBeenDismissedKey, @(YES), OBJC_ASSOCIATION_RETAIN);
}
